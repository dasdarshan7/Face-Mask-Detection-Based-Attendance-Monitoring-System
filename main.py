...
while True:
	...
	for (box, pred) in zip(locs, preds):
		...
		label = "Mask, Press Q for Attendance" if mask > withoutMask else "No Mask, No Mask No Attendance"
		color = (0, 255, 0) if label == "Mask, Press Q for Attendance" else (0, 0, 255)
